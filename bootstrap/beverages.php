	...
	<div class="Container">
		...
		<div class="content">
			...
			<div style="width: 100%; height: 100%;background-color: #1f1b24; padding-top: 3%;" align="center">
				...
				<a href="beverages.php"><button class="btn btn-success active" name="coffee">BEVERAGES</button></a>
		...
		$sql = "SELECT * FROM products WHERE category = 'Beverages' ORDER BY id ASC"; 
