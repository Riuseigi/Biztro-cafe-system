	...
	<div class="Container">
		...
		<div class="content">
			...
			<div style="width: 100%; height: 100%;background-color: #1f1b24; padding-top: 3%;" align="center">
				...
				<a href="liqour.php"><button class="btn btn-success active" name="coffee">LIQOUR</button></a>
			</div>
		</aside>
		<div align="right">
		...
		$sql = "SELECT * FROM products WHERE category = 'Liqours' ORDER BY id ASC"; 
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<select name="category" id="category" class="form-control">
							...
							<option value="Coffee">Coffee</option>
							<option value="Foods" >Food</option>
							<option value="Liqours" selected="">Liqour</option>  
							<option value="Milktea">Milktea</option>
							<option value="Rice Bowls">Rice Bowl</option>  
							<option value="Snacks">Snacks</option>
							<option value="Toppings">Toppings</option>
