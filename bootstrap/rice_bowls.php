	...
	<div class="Container">
		...
		<div class="content">
			...
			<div style="width: 100%; height: 100%;background-color: #1f1b24; padding-top: 3%;" align="center">
				...
				<a href="rice_bowls.php"><button class="btn btn-success active" name="coffee">RICE BOWLS</button></a>
				...
				<a href="coffee.php"><button class="btn btn-success" name="coffee">COFFEE</button></a>
		...
		$sql = "SELECT * FROM products WHERE category = 'Rice Bowls' ORDER BY id ASC"; 
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<select name="category" id="category" class="form-control">
							...
							<option value="Liqours">Liqour</option>  
							<option value="Milktea">Milktea</option>
							<option value="Rice Bowls" selected="">Rice Bowl</option>  
							<option value="Snacks" >Snacks</option>
							<option value="Toppings">Toppings</option>
						</select>
						<br>
