	...
	<div class="Container">
		...
		<div class="content">
			...
			<div style="width: 100%; height: 100%;background-color: #1f1b24; padding-top: 3%;" align="center">
				...
				<a href="stocks.php"><button class="btn btn-success active" name="coffee">FOODS</button></a>
		...
		$sql = "SELECT * FROM products WHERE category = 'Foods' ORDER BY id ASC"; 
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<select name="category" id="category" class="form-control">
							<option value="Beverages">Beverages</option>  
							<option value="Coffee">Coffee</option>
							<option value="Foods" selected="">Food</option>
							<option value="Liqours">Liqour</option>  
							<option value="Milktea">Milktea</option>
							<option value="Rice Bowls">Rice Bowl</option>  
							<option value="Snacks">Snacks</option>
