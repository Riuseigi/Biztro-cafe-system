	...
	<div class="Container">
		...
		<div class="content">
			...
			<div style="width: 100%; height: 100%;background-color: #1f1b24; padding-top: 3%;" align="center">
				...
				<a href="snacks.php"><button class="btn btn-success active" name="coffee">SNACKS</button></a>
		...
		$sql = "SELECT * FROM products WHERE category = 'Toppings' ORDER BY id ASC"; 
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<select name="category" id="category" class="form-control">
							...
							<option value="Rice Bowls">Rice Bowl</option>  
							<option value="Snacks" >Snacks</option>
							<option value="Toppings" selected="">Toppings</option>
						</select>
						<br>
					</div>
					<div class="modal-footer">
